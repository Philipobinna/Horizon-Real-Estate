...
router.delete("/delete_user/:id", AuthMiddleware.Authenticate(["admin"]), Controller.deleteUser);
router.post('/image', upload.single('image'), AuthMiddleware.Authenticate(["user", "admin"]), Controller.imageUpload);
router.get("/getUsers", AuthMiddleware.Authenticate(["admin"]), Controller.getUsers);
